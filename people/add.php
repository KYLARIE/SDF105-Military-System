...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $data = [
        ...
        'email' => trim($_POST['email'] ?? null), // ✅ Added email
    ...
    $stmt = $pdo->prepare("
        INSERT INTO people 
        (name, age, contact, email, rank_id, unit_id, military_status, health_id, superior_id, file_upload) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    ");
